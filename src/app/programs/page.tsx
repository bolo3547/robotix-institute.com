...
const programs = [
  ...
  },
  {
    ...
    ageGroup: '13-18 years',
    level: 'Intermediate',
    description: 'Build modern websites and web apps using HTML, CSS, and JavaScript with hands-on project work.',
    image: '🌐',
    highlights: ['HTML, CSS & JS', 'Responsive design', 'Deploy live projects'],
    price: 'Contact Us',
    duration: 'Per Cohort',
    schedule: 'Weekends at BongoHive',
    maxStudents: 12,
