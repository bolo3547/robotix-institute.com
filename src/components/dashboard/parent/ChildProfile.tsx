    ...
    >
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="flex items-center gap-6">
          <div className="text-6xl">{child.profileImage}</div>
          <div>
            <h3 className="text-2xl font-bold text-gray-900">{child.name}</h3>
            <p className="text-gray-600 text-lg">{child.age} years old</p>
            <div className="flex items-center gap-2 text-blue-600 mt-3 font-semibold">
        ...
        <div className="grid grid-cols-2 gap-4 flex-1">
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-4 border border-blue-200">
            ...
            <div className="text-3xl font-bold text-blue-600 mt-2">{child.totalHours}</div>
            <div className="text-xs text-gray-500 mt-2">hours completed</div>
          </div>

          <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg p-4 border border-purple-200">
            <div className="text-sm text-gray-600 font-medium">Duration</div>
            <div className="text-3xl font-bold text-purple-600 mt-2">{monthsActive}</div>
            <div className="text-xs text-gray-500 mt-2">months active</div>
          </div>

          <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-4 border border-green-200 col-span-2">
