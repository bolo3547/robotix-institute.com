          ...
          <tbody>
            {attendance.map((record, idx) => {
              ...
              return (
                ...
                >
                  <td className="py-3 px-4 text-gray-900 font-medium">{record.week}</td>
                  <td className="py-3 px-4 text-gray-700">{record.attended} days</td>
                  <td className="py-3 px-4 text-gray-700">{record.total} days</td>
