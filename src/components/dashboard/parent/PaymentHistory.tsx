    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mb-6 sm:mb-8">
        <div className="bg-blue-50 rounded-lg p-3 sm:p-4 border border-blue-200">
          ...
          <p className="text-lg sm:text-2xl font-bold text-blue-600 mt-1">ZMW {totalAmount.toLocaleString()}</p>
        </div>
        <div className="bg-green-50 rounded-lg p-3 sm:p-4 border border-green-200">
          <p className="text-xs sm:text-sm text-gray-600">Paid</p>
          <p className="text-lg sm:text-2xl font-bold text-green-600 mt-1">ZMW {paidAmount.toLocaleString()}</p>
        </div>
        <div className="bg-orange-50 rounded-lg p-3 sm:p-4 border border-orange-200">
          <p className="text-xs sm:text-sm text-gray-600">Outstanding</p>
          <p className="text-lg sm:text-2xl font-bold text-orange-600 mt-1">ZMW {(totalAmount - paidAmount).toLocaleString()}</p>
        </div>
      </div>
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-gray-200">
              ...
              <th className="text-left py-2 sm:py-3 px-2 sm:px-4 font-semibold text-gray-700 text-xs sm:text-sm">Receipt</th>
            </tr>
          </thead>
          <tbody>
            {payments.map((payment, idx) => {
              ...
              return (
                ...
                >
                  <td className="py-2 sm:py-3 px-2 sm:px-4 text-gray-900 font-medium text-xs sm:text-sm whitespace-nowrap">{new Date(payment.date).toLocaleDateString()}</td>
                  <td className="py-2 sm:py-3 px-2 sm:px-4 text-gray-700 text-xs sm:text-sm">{payment.description}</td>
                  <td className="py-2 sm:py-3 px-2 sm:px-4 font-semibold text-xs sm:text-sm whitespace-nowrap">{payment.currency || 'ZMW'} {payment.amount.toLocaleString()}</td>
                  <td className="py-2 sm:py-3 px-2 sm:px-4">
                    <div className={`flex items-center gap-1 sm:gap-2 font-semibold text-xs sm:text-sm ${config.text}`}>
